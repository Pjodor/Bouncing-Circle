...
local function onRestartBtnRelease()
	...
	storyboard.removeAll()
	storyboard.gotoScene( "lvltwo", "fade", 0 )
...
function scene:createScene( event )
	...
	local hinder = display.newRect( 0, 0, 20, display.contentHeight * 0.25 )
	hinder:setReferencePoint( display.BottomLeftReferencePoint )
	hinder.x = display.contentWidth * 0.5
	hinder.y = display.contentHeight * 0.96
	...
	local hinder2 = display.newRect( 0, 0, 20, display.contentHeight * 0.5 )
	hinder2:setReferencePoint( display.BottomLeftReferencePoint )
	hinder2.x = display.contentWidth * 0.5
	hinder2.y = display.contentHeight * 0.6
	...
	finnish.x = display.contentWidth * 0.9
	...
	gold.y = display.contentHeight * 0.8
